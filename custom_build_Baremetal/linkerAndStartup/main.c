...
=======                       CONSTANTS  &  TYPES                       =======
=============================================================================*/
/* Create Constants to test the linker script; not really needed for application */
const uint8_t delay_ui8 = 200;
const uint8_t delayMd_ui8 = 225;
const uint8_t delayLg_ui8 = 250;
uint32_t test1; 
uint32_t test2;
